...
const BiLSTMStockAnalysis = () => {
  return (
    ...
    return scaler, scaled_data`}
            ...
            <ul className="list-disc pl-6 mt-4">
              <li><strong>Purpose</strong>: Normalize the 'Close' prices for better performance with BiLSTM.</li>
              <li><strong>Inputs</strong>:
                <ul className="list-circle pl-6">
    ...
    return X_train, y_train, X_test, y_test`}
            ...
            <ul className="list-disc pl-6 mt-4">
              <li><strong>Purpose</strong>: Splits normalized data into training and testing sets and creates sequences for BiLSTM input.</li>
              <li><strong>Outputs</strong>: Sequences and targets for training and testing datasets reshaped for BiLSTM.</li>
            </ul>
          </AccordionContent>
        </AccordionItem>

        <AccordionItem value="item-4">
          <AccordionTrigger>4. Build and Train BiLSTM Model</AccordionTrigger>
          <AccordionContent>
            <pre className="bg-gray-100 p-4 rounded-md overflow-x-auto dark:bg-zinc-900">
              <code className="text-sm">
...
export default BiLSTMStockAnalysis