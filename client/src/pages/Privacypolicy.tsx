    ...
    return (
        <div className="min-h-screen bg-background text-foreground p-8">
            <div className="max-w-4xl mx-auto">
                <h1 className="text-4xl font-bold mb-6">PredictHub Privacy Policy</h1>
                ...
                <ScrollArea className="h-[600px] rounded-md border p-4">
                    <div className="pr-4">
                        <section className="mb-8">
                            ...
                            <p>Welcome to PredictHub. We value your privacy and are committed to protecting the personal information you share with us. This Privacy Policy explains how we collect, use, and safeguard your data when you visit our website or interact with our services.</p>
                        </section>
                        ...
                        <section className="mb-8">
                            ...
                            <p className="mt-4">To exercise any of these rights, please contact us at [insert contact email].</p>
                        </section>
                        ...
                        <section className="mb-8">
                            ...
                            <p>If you have any questions about this Privacy Policy, please contact us <a href="https://forms.gle/ecvJx1M12NfoJvrb9" className="text-blue-300 underline" target="_blank" rel="noopener noreferrer">here</a>.</p>
                        </section>
                    </div>
                </ScrollArea>
            </div>
